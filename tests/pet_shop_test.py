...
class TestPetShop(unittest.TestCase):
    ...
    def test_total_cash(self):       # this function has to return the total cash 
        sum = get_total_cash(self.cc_pet_shop) # function name 
        self.assertEqual(1000, sum)   # we should get 1000


    def test_add_or_remove_cash__add(self):      # not return anything / simply change the value of that cash 
        add_or_remove_cash(self.cc_pet_shop,10)     # in this test we test add cash  
        cash = get_total_cash(self.cc_pet_shop)
        self.assertEqual(1010, cash)   # what should be returned 
    ...
    def test_pets_sold(self):                    # don't return a value / but modify something
